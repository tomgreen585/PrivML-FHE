import sys
from mn_data_loader import ML_Data_Loader
from mn_preprocessing import ML_Preprocessing
from mn_model import ML_Model
from mn_training import ML_Training_Class
from mn_testing import ML_Testing_Class
from mn_save import ML_Saving_Model
...
class ML_Main:
    ...
    def preprocess_data(self, images, labels, run_type):
        ...
        x_plain_train, y_plain_train, x_plain_val, y_plain_val, x_plain_test, y_plain_test = preprocess.preprocessing_steps(images, labels, run_type)
    ...
    def ml_main_pipeline(self, run_type):
        ...
        if run_type == "Testing":
            ...
            x_plain_train, y_plain_train, x_plain_val, y_plain_val, x_plain_test, y_plain_test = self.preprocess_data(images, labels, run_type)
