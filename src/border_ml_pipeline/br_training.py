...
from br_config import (OPTIMIZER, LOSS_FUNCTION)
...
class ML_Training_Class:
    ...
    def train_model(self, model, x_train, y_train, x_val, y_val, epochs, batch_size, learning_rate):
        ...
        flatten_preds = val_preds.reshape((val_preds.shape[0], -1))
        flatten_labels = val_labels.reshape((val_labels.shape[0], -1))
