import sys
from br_data_loader import ML_Data_Loader
from br_preprocessing import ML_Preprocessing
from br_model import ML_Model
from br_training import ML_Training_Class
from br_testing import ML_Testing_Class
from br_save import ML_Saving_Model
from br_evaluation import Ml_Metrics_Evaluation
...
class ML_Main:
    ...
    def preprocess_data(self, x_data, y_data, run_type):
        ...
        Returns:
        train/val/test splits for x and y
        """
        print("[INFO] Performing Preprocessing Steps on the Data")
        
        preprocess = ML_Preprocessing()
       
        x_plain_train, y_plain_train, x_plain_val, y_plain_val, x_plain_test, y_plain_test = preprocess.preprocessing_steps(x_data, y_data, run_type)
    ...
    def ml_main_pipeline(self, run_type):
        ...
        if run_type == "Testing":
            ...
            x_plain_train, y_plain_train, x_plain_val, y_plain_val, x_plain_test, y_plain_test = self.preprocess_data(x_data, y_data, run_type)
