...
from br_config import (
    ...
    EN_KERNEL_SIZE, EN_STRIDE, EN_PADDING, DE_KERNEL_SIZE, DE_STRIDE, DE_PADDING,
...
class Ml_Metrics_Evaluation:
    ...
    def save_ml_metrics_csv():
        ...
        os.makedirs("br_outputs", exist_ok=True)
    ...
    def create_ml_report(model_id):
        ...
        elements.append(Paragraph(f"Conv1 Kernel Size: {EN_KERNEL_SIZE}", styles['Normal']))
        elements.append(Paragraph(f"Conv1 Stride Size: {EN_STRIDE}", styles['Normal']))
        elements.append(Paragraph(f"Conv1 Padding Size: {EN_PADDING}", styles['Normal']))
        elements.append(Paragraph(f"Conv2 Kernel Size: {EN_KERNEL_SIZE}", styles['Normal']))
        elements.append(Paragraph(f"Conv2 Stride Size: {EN_STRIDE}", styles['Normal']))
        elements.append(Paragraph(f"Conv2 Padding Size: {EN_PADDING}", styles['Normal']))
        elements.append(Paragraph(f"Deconv1 Kernel Size: {DE_KERNEL_SIZE}", styles['Normal']))
        elements.append(Paragraph(f"Deconv1 Stride Size: {DE_STRIDE}", styles['Normal']))
        elements.append(Paragraph(f"Deconv1 Padding Size: {DE_PADDING}", styles['Normal']))
        elements.append(Paragraph(f"Deconv2 Kernel Size: {DE_KERNEL_SIZE}", styles['Normal']))
        elements.append(Paragraph(f"Deconv2 Stride Size: {DE_STRIDE}", styles['Normal']))
        elements.append(Paragraph(f"Deconv2 Padding Size: {DE_PADDING}", styles['Normal']))
