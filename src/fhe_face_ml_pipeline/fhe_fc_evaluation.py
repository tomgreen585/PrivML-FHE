...
from fhe_fc_config import (
    ...
    SEED, TRAINING_SIZE, VALIDATION_SIZE, TESTING_SIZE, ENCRYPTED_SIZE
)
...
class Ml_Metrics_Evaluation:
    ...
    def save_ml_metrics_csv():
        ...
        os.makedirs("fhe_fc_outputs", exist_ok=True)
        if os.path.isfile("fhe_fc_outputs/metrics.csv"):
            with open("fhe_fc_outputs/metrics.csv", 'r', newline='') as f:
        ...
        file_exists = os.path.isfile("fhe_fc_outputs/metrics.csv")
        with open("fhe_fc_outputs/metrics.csv", 'a', newline='') as csvfile:
    ...
    def create_ml_report(model_id):
        ...
        os.makedirs("fhe_fc_outputs", exist_ok=True)
        output_filename = f"fhe_fc_outputs/ml_metrics_report_model_{model_id}.pdf"
