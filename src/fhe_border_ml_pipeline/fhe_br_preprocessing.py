...
from fhe_br_config import (SEED, TRAINING_SIZE, VALIDATION_SIZE, TESTING_SIZE, ENCRYPTED_SIZE)
...
class ML_Preprocessing:
    ...
    encryption_size (float): size of data for encryption
    ...
    def preprocessing_steps(self, x_data, y_data, run_type):
        ...
        if `run_type` is "Testing". Splits data into train/val/test/encryption sets
        ...
        Returns:
        training, validation, test, and encryption sets
        """
