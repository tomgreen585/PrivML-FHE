...
from fhe_fc_config import (SEED, TRAINING_SIZE, VALIDATION_SIZE, TESTING_SIZE, ENCRYPTED_SIZE)

"""
preprocessing.py

Performs data processing. Splits dataset into training, validation, test and encryption sets using fixed sizes. Converts
...
class ML_Preprocessing:
    ...
    def preprocessing_steps(self, x_data, y_data, run_type):
        ...
        if `run_type` is "Testing". Splits data into train/val/test/encrypted sets
        ...
        x_plain_test, y_plain_test, x_enc_test, y_enc_test = self.perform_dataset_split(x_data, y_data)
