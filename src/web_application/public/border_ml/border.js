...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //predefine template images, allowing clicking on images to simulate user upload of file
  ...
  sendBtn.addEventListener('click', async () => {
    ...
    try { //construct request
      const res = await fetch('/api/border/upload', { method: 'POST', body: form });
    ...
    const es = new EventSource(`/api/border/stream/${jobId}`);
